...
import Bin from "./OSWAP_BridgeVault2.json";
...
export class OSWAP_BridgeVault2 extends _Contract{
    ...
    parseRequestCancelOrderOnSourceChainEvent(receipt: TransactionReceipt): OSWAP_BridgeVault2.RequestCancelOrderOnSourceChainEvent[]{
        return this.parseEvents(receipt, "RequestCancelOrderOnSourceChain").map(e=>this.decodeRequestCancelOrderOnSourceChainEvent(e));
    }
    ...
    parseVoidUserCancelOrderEvent(receipt: TransactionReceipt): OSWAP_BridgeVault2.VoidUserCancelOrderEvent[]{
        return this.parseEvents(receipt, "VoidUserCancelOrder").map(e=>this.decodeVoidUserCancelOrderEvent(e));
    }
    ...
    private assign(){
        ...
        let orderRequestCancelDate_call = async (param1:number|BigNumber, options?: TransactionOptions): Promise<BigNumber> => {
            let result = await this.call('orderRequestCancelDate',[this.wallet.utils.toString(param1)],options);
            return new BigNumber(result);
        }
        this.orderRequestCancelDate = orderRequestCancelDate_call
        ...
        let init_send = async (vaultRegistry:string, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('init',[vaultRegistry],options);
            return result;
        }
        let init_call = async (vaultRegistry:string, options?: TransactionOptions): Promise<void> => {
            let result = await this.call('init',[vaultRegistry],options);
            return;
        }
        ...
        let requestCancelOrderOnSourceChain_send = async (orderId:number|BigNumber, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('requestCancelOrderOnSourceChain',[this.wallet.utils.toString(orderId)],options);
            return result;
        }
        let requestCancelOrderOnSourceChain_call = async (orderId:number|BigNumber, options?: TransactionOptions): Promise<void> => {
            let result = await this.call('requestCancelOrderOnSourceChain',[this.wallet.utils.toString(orderId)],options);
            return;
        }
        this.requestCancelOrderOnSourceChain = Object.assign(requestCancelOrderOnSourceChain_send, {
            call:requestCancelOrderOnSourceChain_call
        });
        ...
        let voidUserCancelOrderParams = (params: IVoidUserCancelOrderParams) => [this.wallet.utils.stringToBytes(params.signatures),this.wallet.utils.toString(params.orderId)];
        let voidUserCancelOrder_send = async (params: IVoidUserCancelOrderParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('voidUserCancelOrder',voidUserCancelOrderParams(params),options);
            return result;
        }
        let voidUserCancelOrder_call = async (params: IVoidUserCancelOrderParams, options?: TransactionOptions): Promise<void> => {
            let result = await this.call('voidUserCancelOrder',voidUserCancelOrderParams(params),options);
            return;
        }
        this.voidUserCancelOrder = Object.assign(voidUserCancelOrder_send, {
            call:voidUserCancelOrder_call
        });
...
export module OSWAP_BridgeVault2{
    ...
    export interface RequestCancelOrderOnSourceChainEvent {orderId:BigNumber,_event:Event}
    ...
    export interface VoidUserCancelOrderEvent {orderId:BigNumber,signers:BigNumber[],_event:Event}
