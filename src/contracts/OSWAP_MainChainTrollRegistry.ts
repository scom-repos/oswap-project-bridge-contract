...
export interface IStakeTrollParams {trollProfileIndex:number|BigNumber;nft:string;tokenId:number|BigNumber}
...
export class OSWAP_MainChainTrollRegistry extends _Contract{
    ...
    private assign(){
        ...
        let addStakesTrollParams = (params: IAddStakesTrollParams) => [params.nft,this.wallet.utils.toString(params.tokenId),this.wallet.utils.toString(params.amount)];
        let addStakesTroll_send = async (params: IAddStakesTrollParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('addStakesTroll',addStakesTrollParams(params),options);
            return result;
        }
        let addStakesTroll_call = async (params: IAddStakesTrollParams, options?: TransactionOptions): Promise<void> => {
        ...
        let stakeTrollParams = (params: IStakeTrollParams) => [this.wallet.utils.toString(params.trollProfileIndex),params.nft,this.wallet.utils.toString(params.tokenId)];
        let stakeTroll_send = async (params: IStakeTrollParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('stakeTroll',stakeTrollParams(params),options);
            return result;
        }
        let stakeTroll_call = async (params: IStakeTrollParams, options?: TransactionOptions): Promise<void> => {
        ...
        let unstakeTrollParams = (params: IUnstakeTrollParams) => [params.nft,this.wallet.utils.toString(params.tokenId)];
        let unstakeTroll_send = async (params: IUnstakeTrollParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('unstakeTroll',unstakeTrollParams(params),options);
            return result;
        }
        let unstakeTroll_call = async (params: IUnstakeTrollParams, options?: TransactionOptions): Promise<BigNumber> => {
...
export module OSWAP_MainChainTrollRegistry{
    ...
    export interface StakeTrollEvent {backer:string,trollProfileIndex:BigNumber,nft:string,tokenId:BigNumber,stakesChange:BigNumber,stakesBalance:BigNumber,_event:Event}
