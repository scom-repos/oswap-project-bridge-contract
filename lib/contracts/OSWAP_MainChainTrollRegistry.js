    ...
    assign() {
        ...
        let getTrollProperties_call = async (trollProfileIndex, options) => {
            ...
            return {
                troll: {
                    ...
                    nonce: new eth_contract_1.BigNumber(result.troll.nonce),
        ...
        let getTrolls_call = async (params, options) => {
            ...
            return (result.map(e => ({
                ...
                nonce: new eth_contract_1.BigNumber(e.nonce),
        ...
        let addTrollParams = (params) => [params.troll, this.wallet.utils.toString(params.trollType), this.wallet.utils.toString(params.ownerNonce), this.wallet.utils.stringToBytes(params.ownerSignature), this.wallet.utils.stringToBytes(params.trollSignature)];
        ...
        let updateTrollParams = (params) => [this.wallet.utils.toString(params.trollProfileIndex), params.newTroll, this.wallet.utils.toString(params.ownerNonce), this.wallet.utils.stringToBytes(params.ownerSignature), this.wallet.utils.stringToBytes(params.trollSignature)];
