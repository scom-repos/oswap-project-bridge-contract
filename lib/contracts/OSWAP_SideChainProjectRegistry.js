...
class OSWAP_SideChainProjectRegistry extends eth_contract_1.Contract {
    ...
    assign() {
        ...
        let hashAddTrollParams = (params) => [this.wallet.utils.toString(params.trollProfileIndex), params.troll, this.wallet.utils.toString(params.nonce)];
        ...
        let hashUpdateTrollFromTrollParams = (params) => [this.wallet.utils.toString(params.trollProfileIndex), params.newTroll, this.wallet.utils.toString(params.nonce)];
        let hashUpdateTrollFromTroll_call = async (params, options) => {
        ...
        let addTrollParams = (params) => [this.wallet.utils.stringToBytes(params.signatures), this.wallet.utils.toString(params.trollProfileIndex), params.troll, this.wallet.utils.toString(params.nonce)];
        ...
        let updateTrollParams = (params) => [this.wallet.utils.stringToBytes(params.signatures), this.wallet.utils.stringToBytes(params.trollSignature), this.wallet.utils.toString(params.trollProfileIndex), params.newTroll, this.wallet.utils.toString(params.nonceForTrollSignature), this.wallet.utils.toString(params.nonce)];
