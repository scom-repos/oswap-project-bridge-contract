...
exports.OSWAP_BridgeVault2 = void 0;
const eth_contract_1 = require("@ijstech/eth-contract");
const OSWAP_BridgeVault2_json_1 = __importDefault(require("./OSWAP_BridgeVault2.json"));
class OSWAP_BridgeVault2 extends eth_contract_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, OSWAP_BridgeVault2_json_1.default.abi, OSWAP_BridgeVault2_json_1.default.bytecode);
        this.assign();
    }
    deploy(options) {
    ...
    assign() {
        ...
        let orderRequestCancelDate_call = async (param1, options) => {
        ...
        let projectId_call = async (options) => {
        ...
        let init_send = async (vaultRegistry, options) => {
            let result = await this.send('init', [vaultRegistry], options);
            return result;
        };
        let init_call = async (vaultRegistry, options) => {
        ...
        let requestCancelOrderOnSourceChain_send = async (orderId, options) => {
            let result = await this.send('requestCancelOrderOnSourceChain', [this.wallet.utils.toString(orderId)], options);
            return result;
        };
        let requestCancelOrderOnSourceChain_call = async (orderId, options) => {
        ...
        let voidUserCancelOrderParams = (params) => [this.wallet.utils.stringToBytes(params.signatures), this.wallet.utils.toString(params.orderId)];
        let voidUserCancelOrder_send = async (params, options) => {
            let result = await this.send('voidUserCancelOrder', voidUserCancelOrderParams(params), options);
            return result;
        };
        let voidUserCancelOrder_call = async (params, options) => {
...
OSWAP_BridgeVault2._abi = OSWAP_BridgeVault2_json_1.default.abi;
exports.OSWAP_BridgeVault2 = OSWAP_BridgeVault2;
